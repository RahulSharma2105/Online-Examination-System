...
<head>
  ...
  <title>Smart Examination System</title>
  ...
  <style>
    .main_header {
      ...
      width: 100%;
      min-height: 91.3vh;
      background-image: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url('test23.jpg');
  ...
  ?>
    ...
    <div class="text-light my-5">
      <center>
        ...
        ?>
          <h1 class="bg-primary py-2 text-light">Welcome <?php
      ...
      <div class="mx-4" style="min-height:62.96vh;">
        ...
        <h3 class="mt-5 text-dark">SELECT YOUR TOPIC (10 Questions in 10 Minutes)</h3>
    ...
    <section>
      ...
      <div class="main_header">
        <div class="header_left">
          <p>Smart Exam<br>A Novel Way To Approach.</p>
